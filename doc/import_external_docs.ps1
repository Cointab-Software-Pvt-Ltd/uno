...
$external_docs = @{
    ...
    "uno.toolkit.ui" = @{ ref="f9bf18f748f9f6f2e5dda0b959b464656ff1a129" } #latest main commit
    ...
    "uno.chefs" = @{ ref="53030d9fd54623c13de370afca9213a7921021de" } #latest main commit
